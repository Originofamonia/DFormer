"""
1. Train on all labeled RGB-D pairs
2. Infer masks for unlabeled pairs as ground truths
"""
...
from utils.dataloader.dataloader import get_unlabeled_loaders
...
if __name__ == '__main__':
    with Engine(custom_parser=parser) as engine:
        ...
        train_loader, val_loader, train_sampler, val_sampler = get_unlabeled_loaders(engine, TravRGBDLabeledDataset, config, 
            labeled_csv="/home/edward/data/segmentation_indoor_images/labeled_rgbd_pairs.csv",
            unlabeled_csv='/home/edward/data/trav/unlabeled_image_depth_pair.csv')
